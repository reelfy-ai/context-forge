"""Multi-turn simulation tests for stale memory detection (Level 3).

LEVEL 3: Full Simulation Harness
================================
These tests use the complete simulation infrastructure:
- Personas: Define user characteristics
- Scenarios: Multi-turn conversation flows
- SimulationRunner: Orchestrates the conversation
- LangGraphAdapter: Bridges the agent and simulator

For simpler single-turn evaluation, see tests/trajectories/simple/
...
- MemoryHygieneJudge: Checks SEMANTICS (missed facts, hallucinations)
